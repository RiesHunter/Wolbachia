...
### ---------------------------------------------------------------------------------------------------- ###
## Parameters
workingdir="/Users/rieshunter/Google Drive/Shared drives/TCF lab/Current Lab Members/Hunter_Ries/Wolbachia/data/reads/data/run/test_r1"
...
bwa mem -t 4 "$reference" ./06_norm/06-norm_${sample}_L001_r1.fastq > ./06_norm/relaxed_norm_${sample}.bam  2>>_stderr.txt
